...
/**
 * @Entity (repositoryClass="MfgOrderStatesRepository")
 * @Table(name="mfg_order_states")
 **/
class MfgOrderState implements JsonSerializable {

    /**
     * @Id
     * @ManyToOne(targetEntity = "MfgOrder", fetch = "EAGER", inversedBy = "states")
